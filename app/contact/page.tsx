    ...
    <>
                ...
                <div className="flex items-start gap-4 p-6 bg-[#F8FAFC] rounded-xl border-2 border-[#E5E7EB]">
                  ...
                  <div>
                    ...
                    <p className="text-[#3B4A6B] text-base">
                      123, Furniture Market, <br />Kirti Nagar, New Delhi, <br />India - 110015
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4 p-6 bg-[#F8FAFC] rounded-xl border-2 border-[#E5E7EB]">
      ...
      <section className="pb-24">
        <div className="container">
          ...
          <div className="h-[450px] w-full rounded-2xl overflow-hidden border-2 border-[#E5E7EB] bg-[#E5E7EB]">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3501.2434769433094!2d77.1658!3d28.6519!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjjCsDM5JzA2LjgiTiA3N8KwMDknNTYuOSJF!5e0!3m2!1sen!2sin!4v1234567890"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
      ...
      <section className="py-20 bg-[#081F44] text-white text-center">
        <div className="container">
          ...
          <p className="text-xl opacity-90 max-w-2xl mx-auto mb-10">Get expert advice and best market rates. Call us or visit our store in Kirti Nagar.</p>
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <a href="tel:+919876543210" className="inline-flex items-center justify-center gap-2 px-12 py-4 bg-[#A4161A] text-white font-bold text-lg rounded-lg hover:bg-[#C41E3A] transition-all">
              <Phone className="w-6 h-6" />
              Call Now: +91 98765 43210
            </a>
            <Link href="/plywood" className="inline-flex items-center justify-center gap-2 px-12 py-4 border-2 border-white text-white font-bold text-lg rounded-lg hover:bg-white hover:text-[#081F44] transition-all">
              Explore Products
            </Link>
          </div>
        </div>
